...
public class LearnerSkillIQRecyclerAdapter extends RecyclerView.Adapter<LearnerSkillIQRecyclerAdapter.ViewHolder> {
    ...
    public LearnerSkillIQRecyclerAdapter(Context context) {
        mContext = context;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = mLayoutInflater.inflate(R.layout.list_item_skills, parent, false);
